---
title: Fuwari 模板 Demo 参考
published: 2026-09-12
description: 从模板自带 Demo 合并而来的参考稿，仅草稿，不在首页展示。写文章时可对照这里的 Markdown / 组件示例。
image: "./cover.jpeg"
tags: [参考, Fuwari, Demo]
category: 参考
draft: true
...
> 这篇把原先散落的 Fuwari Demo 文合并到一处，方便以后对照。**`draft: true`**，生产环境首页不会显示。
...
_原 `markdown-extended.md`：GitHub 卡片、Admonitions 等_
...
_原 `guide/index.md`：frontmatter、目录结构等_
...
_原 `draft.md`：`draft: true` 时不会出现在正式站点_
